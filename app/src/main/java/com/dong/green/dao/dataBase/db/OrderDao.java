...
public class OrderDao extends AbstractDao<Order, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Net_order_code = new Property(1, String.class, "net_order_code", false, "NET_ORDER_CODE");
        public final static Property Pay_method = new Property(2, int.class, "pay_method", false, "PAY_METHOD");
        public final static Property Pay_code = new Property(3, String.class, "pay_code", false, "PAY_CODE");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ORDER\" (" + //
                ...
                "\"NET_ORDER_CODE\" TEXT," + // 1: net_order_code
                "\"PAY_METHOD\" INTEGER NOT NULL ," + // 2: pay_method
                "\"PAY_CODE\" TEXT," + // 3: pay_code
                "\"UID\" INTEGER);"); // 4: uid
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Order entity) {
        ...
        String net_order_code = entity.getNet_order_code();
        if (net_order_code != null) {
            stmt.bindString(2, net_order_code);
        }
        stmt.bindLong(3, entity.getPay_method());
 
        String pay_code = entity.getPay_code();
        if (pay_code != null) {
            stmt.bindString(4, pay_code);
        }
    ...
    public Order readEntity(Cursor cursor, int offset) {
        Order entity = new Order( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // net_order_code
            cursor.getInt(offset + 2), // pay_method
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // pay_code
    ...
    public void readEntity(Cursor cursor, Order entity, int offset) {
        ...
        entity.setNet_order_code(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setPay_method(cursor.getInt(offset + 2));
        entity.setPay_code(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN USER T0 ON T.\"UID\"=T0.\"_id\"");
            builder.append(' ');
